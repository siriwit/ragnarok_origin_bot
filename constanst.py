...
button_closes = [
    img.button_close, img.button_close_purple, 
    img.button_close_skill, img.button_close_trading, 
    img.button_map_close, img.button_auto_attack_close, 
    img.button_close_package, img.button_close_red]
